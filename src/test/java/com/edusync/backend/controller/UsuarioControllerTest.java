...
public class UsuarioControllerTest {
    ...
    @Mock
    private com.edusync.backend.service.CodigoVerificacionService codigoVerificacionService;

    @Mock
    private com.edusync.backend.service.FileStorageService fileStorageService;

    @Mock
    private org.springframework.mail.javamail.JavaMailSender mailSender;

    @Mock
    private com.edusync.backend.repository.EventoRepository eventoRepository;

    @Mock
    private com.edusync.backend.repository.GrupoRepository grupoRepository;
